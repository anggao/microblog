...
def after_login(resp):
    ...
    if user is None:
        ...
        db.session.add(user)
        db.session.commit()
        # make the user follow him/herslef
...
@app.route('/usr/<nickname>/<int:page>')
@login_required
...
def follow(nickname):
    ...
    if user == None:
        ...
        return redirect(url_for('index'))
    if user == g.user:
        flash("Your can't follow youself!")
...
def unfollow(nickname):
    ...
    if user == None:
        ...
        return redirect(url_for('index'))
    if user == g.user:
        flash("Your can't unfollow youself")
        return redirect(url_for('user', nickname=nickname))
